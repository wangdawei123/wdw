...
import com.kanfa.news.auth.client.jwt.ServiceAuthUtil;
...
import com.kanfa.news.common.msg.auth.TokenErrorResponse;
import com.kanfa.news.common.msg.auth.TokenForbiddenResponse;
import com.kanfa.news.common.util.ClientUtil;
import com.kanfa.news.gate.feign.ILogService;
...
public class AdminAccessFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        System.out.println(tempContextUrl+"===="+url);
