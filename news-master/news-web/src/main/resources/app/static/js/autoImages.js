(function(w,d){
        ...
        this.Event={
            handleEvent: function(event,lib){
                ...
                switch(event.type){
                    ...
                    case "mousemove":
                        ...
                        current_page=lib.page.liList[lib.page.index].getAttribute('index');
                        if(!!lib.options.limit && ((changeX>0  && current_page>lib.options.limit-2) || (changeX<0 && current_page<1))) return;
                    ...
                    case "touchend":
                        ...
                        var changeX = lib.point.pageX1 - lib.point.pageX2;
                        var changeY = lib.point.pageY1 - lib.point.pageY2;
                        var current_page=lib.page.liList[lib.page.index].getAttribute('index');
                        if(!!lib.options.limit && ((changeX>0  && current_page>lib.options.limit-2) || (changeX<0 && current_page<1))) return;
                        if(lib.page.flag) return;
                        if(Math.abs(changeX)>Math.abs(changeY)) {//&#65533;&#65533;&#65533;&#65533;&#65533;&#188;&#65533;
            ...
            position: function(lib,index){
                ...
                if(!lib.options.isfor){
                    ...
                    lib.options.callBack({"index":parseInt(lib.page.liList[lib.page.index].getAttribute('index'))+1, "total":lib.page.liListTotal});
                }else{
                    if(index==undefined){
                    ...
                    lib.options.callBack({"index":parseInt(lib.page.liList[1].getAttribute('index'))+1, "total":lib.page.liListTotal});
                }
            },
            stop:function(lib){
            ...
            domUpdate: function(lib,type){
                ...
                if(!lib.options.isfor){
                    ...
                    lib.options.callBack({"index":parseInt(index)+1, "total":lib.page.liListTotal});
    ...
    WapImage.prototype = {
        ...
        init:function(){
            ...
            this.page.liListTotal = this.options.dom.getElementsByTagName('li').length;
            ...
            if(this.page.liList.length<3 && this.options.isfor){
