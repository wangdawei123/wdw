        ...
        switch (channelContentType) {
            ...
            case 3:
                ...
                if (contentImage != null) {
                    ...
                    List<ContentImageGroup> images = contentImageGroupMapper.findImages(contentId, LiveCommonEnum.CONSTANT_THREE);
