...
import com.kanfa.news.info.vo.admin.live.Utils.ChangeJumpTypeUtil;
...
import com.kanfa.news.info.mapper.LiveSpecialMapper;
        ...
        for(LiveInfo info :list){
            ...
            for(int i = 0 ; i < specialList.size(); i++){
                ...
                if(special.getLiveStatus().equals(LiveCommonEnum.LIVE_STATUS)){
                    specialMap.put("type",9);
                }else{
                    specialMap.put("type",4);
                }
