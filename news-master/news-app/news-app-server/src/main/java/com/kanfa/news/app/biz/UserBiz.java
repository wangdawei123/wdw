...
import com.kanfa.news.app.mapper.UserMapper;
import com.kanfa.news.app.vo.app.PlatformUser;
import com.kanfa.news.app.vo.user.AppUser;
...
public class UserBiz extends BaseBiz<UserMapper, User> {
     ...
     * app - 更新用户信息
     */
    public AppObjectResponse updateUserInfo(Integer uid ,String nickname, String gender) {
        AppObjectResponse<Object> response = new AppObjectResponse<>();
        // 清除空白字符
        String nameString = StringHelper.trimString(nickname);
        AppUser user = appUserBiz.findByNickname(nameString);
        ...
        Integer r = appUserBiz.updateone(uid ,nameString ,gender);
