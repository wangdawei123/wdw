...
//            List<Map<Integer,String>> list=new ArrayList<>(rows.size());
    ...
    public TableResultResponse<VideoChannelFocusInfo> getPcChannelFocusPage(@RequestParam Map<String, Object> params) {
        return channelFocusServiceFeign.getPcChannelFocusPage(params);
    }
