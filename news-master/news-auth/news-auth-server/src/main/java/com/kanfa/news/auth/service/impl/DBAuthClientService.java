...
import com.kanfa.news.auth.bean.ClientInfo;
import com.kanfa.news.auth.entity.Client;
import com.kanfa.news.auth.mapper.ClientMapper;
import com.kanfa.news.auth.service.AuthClientService;
import com.kanfa.news.auth.util.client.ClientTokenUtil;
import com.kanfa.news.common.exception.auth.ClientInvalidException;
