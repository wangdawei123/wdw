package com.kanfa.news.auth.runner;

import com.kanfa.news.auth.common.util.jwt.RsaKeyHelper;
import com.kanfa.news.auth.configuration.KeyConfiguration;
...
public class AuthServerRunner implements CommandLineRunner {
    ...
    private static final String REDIS_USER_PRI_KEY = "NEWS:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "NEWS:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "NEWS:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "NEWS:AUTH:CLIENT:PUB";
