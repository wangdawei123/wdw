...
public class ImageHandleHelper {
    ...
    public static final void overlapImage(String bigPath, String smallPath, String outFile) {
        try {
            ...
            g.drawImage(small, x, y - 50, small.getWidth(), small.getHeight(), null);
            g.dispose();
     ...
     * @time:2016年5月27日 下午5:51:20
     */
    public static BufferedImage overlapImage(URL bigPath, URL smallPath) {
        try {
    ...
    public static void main(String[] args) {
        String sourceFilePath = "D://2.png";
        String waterFilePath = "D://1.jpg";
        String saveFilePath = "D://3.png";
        overlapImage(sourceFilePath, waterFilePath, saveFilePath);
    }
}
