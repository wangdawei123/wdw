...
public interface ISearchServiceFeign {
    ...
    String addData(@PathVariable("indexName") String indexName, @PathVariable("typeName") String typeName, @RequestBody List<Map<String, Object>> list);
    ...
    String updateDataById(@PathVariable("indexName") String indexName,
