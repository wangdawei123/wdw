...
import com.kanfa.news.auth.client.interceptor.UserAuthRestInterceptor;
...
public class WebConfiguration extends WebMvcConfigurerAdapter {
    ...
    private ArrayList<String> getExcludeCommonPathPatterns() {
        ...
        String[] urls = {
                ...
                "/cache/**",
                "/api/log/save",
                "/kpiCountLive/pageKpiCountLive/excel",
                "/kpiCountLive/pageKpiCountLiveDetail/excel",
                "/kpiCountLive/pageKpiCountLiveNew/excel",
                "/kpiCount/pageKpiCount/excel",
                "/kpiCount/pageKpiCountDetail/excel",
                "/kpiCountVideo/pageKpiCountVideo/excel",
                "/kpiCountVideo/pageKpiCountVideoDetail/excel",
                "/kpiCountVideo/pageKpiCountVideoNew/excel",
                "/kpi/countcate/excel",
                "/kpi/countchannelcontent/excel",
                "/kpi/countviewcontent/excel",
                "/kpiCountUserContent/pageList/excel",
                "/contentKpiCount/pageList/excel",
                "/file/**",
                "/log/excel",
                "/contentSynchrodataRest/addContent",
                "/operation/excel"
