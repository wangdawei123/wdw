...
public interface ILiveSpecialBindServiceFeign {
    ...
    /**
     * 通过liveSpecialId查找该集合
     * @param
     * @return
     */
    @RequestMapping(value = "/liveSpecialBind/getAllBinds",method = RequestMethod.GET)
    List<LiveSpecialBind> getAllBinds(@RequestParam("liveSpecialId")Integer liveSpecialId);
