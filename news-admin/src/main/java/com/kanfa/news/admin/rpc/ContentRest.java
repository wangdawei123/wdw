...
public class ContentRest extends BaseRPC{
    ...
    @Autowired
    private IContentVideoServiceFeign iContentVideoServiceFeign;
...
//        return new TableResultResponse(allBind.size(),allBind);
     ...
     * @return
     */
    @RequestMapping(value = "/isRecommend", method = RequestMethod.GET)
    public ObjectRestResponse<Integer> isRecommend(@RequestParam("contentId") Integer contentId,
        ...
        return iContentVideoServiceFeign.updateIsRecommend(contentId,isRecommend);
    }
