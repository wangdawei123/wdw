...
public class YouthActivityAddInfo implements Serializable {
    ...
    private Integer activitySkyId;

    public Integer getActivitySkyId() {
        return activitySkyId;
    }

    public void setActivitySkyId(Integer activitySkyId) {
        this.activitySkyId = activitySkyId;
    }
