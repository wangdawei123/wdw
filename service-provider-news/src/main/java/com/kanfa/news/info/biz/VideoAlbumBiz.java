...
import com.kanfa.news.info.mapper.VideoAlbumMapper;
...
public class VideoAlbumBiz extends BaseBiz<VideoAlbumMapper, VideoAlbum> {
    ...
    public VideoAlbum getVideoAlbumById(Integer id){
        return videoAlbumMapper.getVideoAlbumById(id);
    }



    public ObjectRestResponse<Integer> recommendedExist(){
        ObjectRestResponse<Integer> integerObjectRestResponse = new ObjectRestResponse<>();
        Integer integer = videoAlbumMapper.recommendedExist();
        integerObjectRestResponse.setData(integer);
        return integerObjectRestResponse;
    }
