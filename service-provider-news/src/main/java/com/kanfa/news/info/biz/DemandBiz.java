...
import com.kanfa.news.info.mapper.DemandAuthorMapper;
import com.kanfa.news.info.mapper.DemandMapper;
...
public class DemandBiz extends BaseBiz<DemandMapper,Demand> {
    ...
    public Integer insertDemand(DemandInfo entity){
    ...
    public List<String> getAllVideoMD(){
        return demandMapper.getAllVideoMD();
    }
}