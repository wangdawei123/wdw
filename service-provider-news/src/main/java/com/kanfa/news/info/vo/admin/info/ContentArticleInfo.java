...
public class ContentArticleInfo implements Serializable{
    ...
    private TableResultResponse<CommentInfo> pageComment;

    public TableResultResponse<CommentInfo> getPageComment() {
        return pageComment;
    }

    public void setPageComment(TableResultResponse<CommentInfo> pageComment) {
