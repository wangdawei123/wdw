...
import com.kanfa.news.app.vo.admin.info.ContentLocationInfo;
...
public class ContentDao extends AbstractMongodbBaseDao<ContentLocationInfo> {
     ...
     * @return
     */
    public UpdateResult updateSiteContentDetail(ContentInfo contentInfo, Update stat) {
        return mongoTemplate.upsert(new Query(new Criteria().where("cid").is(contentInfo.getId())),stat,ContentLocationInfo.class);
    }
}
