...
public class LiveInfo implements Serializable {
    ...
    private Integer is_show_view_user;
    ...
    public Integer getIs_show_view_user() {
        return is_show_view_user;
    }

    public void setIs_show_view_user(Integer is_show_view_user) {
        this.is_show_view_user = is_show_view_user;
    }
